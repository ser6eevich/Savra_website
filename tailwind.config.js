  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        'silver-accent': {
          DEFAULT: 'var(--color-silver-accent)',
          light: 'var(--color-silver-accent-light)',
          dark: 'var(--color-silver-accent-dark)',
        },
        'platinum': 'var(--color-platinum)',
        'pewter': 'var(--color-pewter)',
        'chrome': 'var(--color-chrome)',
        'silver-bright': 'var(--color-silver-bright)',
        'silver-muted': 'var(--color-silver-muted)',
        'silver-dim': 'var(--color-silver-dim)',
        'silver-dark': 'var(--color-silver-dark)',
        'silver-shadow': 'var(--color-silver-shadow)',
      },
      borderRadius: {
        lg: "var(--radius)",
